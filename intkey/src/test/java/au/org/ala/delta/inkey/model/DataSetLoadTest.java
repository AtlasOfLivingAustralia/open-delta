...
public class DataSetLoadTest extends TestCase {
    ...
    // context.setFileCharacters(new
    // File(icharsFileUrl.toURI()).getAbsolutePath());
    ...
    //
    // List<String> keywordsWithoutSystemDefinedOnes = new
    // ArrayList<String>(context.getCharacterKeywords());
    ...
    //
    // UnorderedMultiStateCharacter charSeedPresence =
    // (UnorderedMultiStateCharacter) ds.getCharacter(2);
    ...
    // List<CharacterDependency> charSeedPresenceDependencies =
    // charSeedPresence.getDependentCharacters();
    ...
    //
    // UnorderedMultiStateCharacter charSeedInShell =
    // (UnorderedMultiStateCharacter) ds.getCharacter(3);
    ...
    // // check the dependencies for this character
    // // check the dependencies for this character
    // List<CharacterDependency> charSeedInShellDependencies =
    // charSeedInShell.getDependentCharacters();
    ...
    // assertEquals("average thickness of seed shell",
    // charAvgThickness.getDescription());
    // assertEquals("mm thick", charAvgThickness.getUnits());
    //
    // IntegerCharacter charAvgNumberOfSeeds = (IntegerCharacter)
    // ds.getCharacter(5);
    // assertEquals("average number of seeds",
    // charAvgNumberOfSeeds.getDescription());
    // assertEquals(null, charAvgNumberOfSeeds.getUnits());
    //
    // OrderedMultiStateCharacter charColor = (OrderedMultiStateCharacter)
    // ds.getCharacter(6);
    ...
    // URL initFileUrl =
    // getClass().getResource("/dataset/controlling_characters_non_auto/intkey.ink");
    // IntkeyContext context = new IntkeyContext(null);
    // context.newDataSetFile(new File(initFileUrl.toURI()).getAbsolutePath());
    //
    // IntkeyDataset ds = context.getDataset();
    ...
    // URL initFileUrl =
    // getClass().getResource("/dataset/controlling_characters_use_first/intkey.ink");
    // IntkeyContext context = new IntkeyContext(null);
    // context.newDataSetFile(new File(initFileUrl.toURI()).getAbsolutePath());
    //
    // IntkeyDataset ds = context.getDataset();
    ...
    //
    // /**
    // * Test a dataset generated using the APPLICABLE CHARACTERS
    // * confor directive
    // *
    // * @throws Exception
    // */
    ...
    // URL initFileUrl =
    // getClass().getResource("/dataset/controlling_characters_applicable_directive/intkey.ink");
    // IntkeyContext context = new IntkeyContext(null);
    // context.newDataSetFile(new File(initFileUrl.toURI()).getAbsolutePath());
    //
    // IntkeyDataset ds = context.getDataset();
    ...
    // UnorderedMultiStateCharacter charSeedPresence =
    // (UnorderedMultiStateCharacter) ds.getCharacter(2);
    // List<CharacterDependency> charSeedDependencies =
    // charSeedPresence.getDependentCharacters();
    //
    ...
    // UnorderedMultiStateCharacter charSeedInShell =
    // (UnorderedMultiStateCharacter) ds.getCharacter(3);
    // List<CharacterDependency> charSeedInShellCharacterDependencies =
    // charSeedInShell.getDependentCharacters();
    //

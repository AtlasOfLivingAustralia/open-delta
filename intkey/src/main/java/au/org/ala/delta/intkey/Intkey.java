...
public class Intkey extends DeltaSingleFrameApplication implements IntkeyUI, DirectivePopulator {
	...
	/**
	 * Used to calculate the best characters in a separate thread, then update the UI accordingly when the operation is finished
	 * 
	 * @author ChrisF
	 * 
	 */
	...
	/**
	 * @return true if the last time the application was closed, advanced mode was in use
	 */

...
public class Intkey extends DeltaSingleFrameApplication {
	...
	protected void startup() {
		...
		JButton btnHelpIntro = new JButton(
				IconHelper
						.createImageIconFromAbsolutePath("/au/org/ala/delta/intkey/resources/icons/helpa.png"));
		...
		JButton btnContextHelp = new JButton(
				IconHelper
						.createImageIconFromAbsolutePath("/au/org/ala/delta/intkey/resources/icons/find.png"));
		...
		_txtFldCmdBar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (_cmdMenus.containsKey(cmdStr)) {
					...
					try {
						IntkeyDirectiveParser.createInstance().parse(
								new InputStreamReader(new ByteArrayInputStream(
										cmdStr.getBytes())), _context);
					} catch (Exception ex) {
						ex.printStackTrace();
					}
				}
	...
	private JMenuBar buildMenus() {
		...
		JMenuItem mnuItNewDataSet = buildMenuItemForDirective(
				new NewDatasetDirective(), "mnuDirectiveNewDataSet");
		...
		JMenuItem mnuItFileTaxaCmd = buildMenuItemForDirective(
				new FileTaxaDirective(), "mnuDirectiveFileTaxa");
	...
	private JMenuItem buildMenuItemForDirective(IntkeyDirective dir,
			String itemName) {
	...
	private class DirectiveMenuActionListener implements ActionListener {
		...
		public DirectiveMenuActionListener(IntkeyDirective dir,
		...
		public void actionPerformed(ActionEvent e) {
			try {
				...
				Logger.log("Error while running directive from menu - %s %s",
						_dir.toString(), ex.getMessage());
				ex.printStackTrace();
			}
		}
	}
	...
	private class CharacterListModel extends AbstractListModel {
		...
		public Object getElementAt(int index) {
			return _characters.get(index).getDescription();
		}
	}
	...
	private class ItemListModel extends AbstractListModel {
		...
		@Override
		public Object getElementAt(int index) {
			return _items.get(index).getDescription();
		}
	}

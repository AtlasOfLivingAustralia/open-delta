...
public class CodeEditor extends JComponent implements Scrollable, TabExpander {
    ...
    private static final int DEFAULT_GUTTER_WIDTH = 35;
    ...
    public CodeEditor(String mimeType) {
        ...
        try {
            ...
            focusKeys.add(getKeyStrokeMethod.invoke(null, new Object[] { new Integer(KeyEvent.VK_TAB),
                    new Integer(InputEvent.CTRL_MASK | InputEvent.SHIFT_MASK) }));
    ...
    /**
     * Returns true if bracket highlighting is enabled, false otherwise. When bracket highlighting is enabled, the bracket matching the one before the caret (if
     * any) is highlighted.
     *
     ...
     * start if start &lt; end, and end if end &gt; start.
     *
     * @param start
     *            The start offset
     * @param end
    ...
    protected void paintLine(Graphics gfx, int line) {
        ...
        if ((line >= 0) && (line < getLineCount())) {
            ...
            if (_gutterWidth > 0) {
                String gutter = String.format("%4d", line + 1);
    ...
    public interface Highlight {
         ...
         */
        void init(CodeEditor textArea, Highlight next);
    ...
    class DocumentHandler implements DocumentListener {
        ...
        /**
         * Gives notification that a portion of the document has been removed. The range is given in terms of what the view last saw (that is, before updating
         * sticky positions).
         *
         * @param evt
         *            the document event
    ...
    class MouseHandler extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent evt) {
            ...
            if ((evt.getModifiers() & InputEvent.BUTTON3_MASK) != 0 && popup != null) {
                popup.show(CodeEditor.this, evt.getX(), evt.getY());
                return;
            }

...
/**
 * Helper class for working with JavaHelp. It mostly delegates to the java help
 * CSH (context sensitive help) class.
 */
public class HelpController {
    ...
    /**
     * All help sets that use this controller should have a key in the map to
     * "root" which points at the root of the help set
     */
     ...
     * 
     * @param helpSet
     *            the (Classloader relative) path to the help set to use.
     */
    ...
    public void setHelpKeyForComponent(Component component, String helpMapKey) {
        CSH.setHelpIDString(component, helpMapKey);
    }
    
    public String getHelpKeyForComponent(Component component) {
        return CSH.getHelpIDString(component);
    }
    ...
    public void enableHelpKey(JFrame frame) {
        ...
        // This is a little dodgy, but we need to respond to help requests when
        // the
        // Frame has focus, but JavaHelp by default creates a new help viewer
        // for this
        // situation which both impacts performance and makes it difficult to
        // configure things
        // like the frame size.
        frame.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (code == KeyEvent.VK_F1 || code == KeyEvent.VK_HELP) {
                    new CSH.DisplayHelpFromSource(helpBroker).actionPerformed(new ActionEvent(rootPane, 0, ""));
                }
            }
    ...
    public void displayHelpTopic(Window activationWindow, String topicID) {
        helpBroker.setActivationWindow(activationWindow);

...
public class SimpleRtfTransferable extends SimpleTransferable {

	public SimpleRtfTransferable(JTextComponent c, int start, int end) {
		super(null, null);
...
class SimpleTransferable implements Transferable, UIResource {
	...
	public SimpleTransferable(String plainData, String htmlData) {
		this.plainData = plainData;
		this.htmlData = htmlData;
	}

	/**
	 * Returns an array of DataFlavor objects indicating the flavors the data can be provided in. The array should be ordered according to preference for providing the data (from most richly

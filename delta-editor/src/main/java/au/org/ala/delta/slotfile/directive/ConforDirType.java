...
import au.org.ala.delta.slotfile.Directive;
import au.org.ala.delta.slotfile.DirectiveArgType;
...
public class ConforDirType {
    ...
    public static Directive[] ConforDirArray = new Directive[] {
        new Directive(new String[] {"XXX", "XXX", "XXX", "XXX"}, 0, ConforDirType.XXX_XXX_XXX_XXX, DirectiveArgType.DIRARG_OTHER, new DirInDefault(), new DirOutDefault()),
        new Directive(new String[] {"ABSOLUTE", "ERROR", "", ""}, 4, ConforDirType.ABSOLUTE_ERROR, DirectiveArgType.DIRARG_CHARREALLIST, new DirInDefault(), new DirOutDefault()),
        new Directive(new String[] {"ACCEPT", "DUPLICATE", "VALUES", ""}, 4, ConforDirType.ACCEPT_DUPLICATE_VALUES, DirectiveArgType.DIRARG_NONE, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"CHARACTER", "FOR", "TAXON", "NAMES"}, 4, ConforDirType.CHARACTER_FOR_TAXON_NAMES, DirectiveArgType.DIRARG_CHAR, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"CHARACTER", "LIST", "", ""}, 5, ConforDirType.CHARACTER_LIST, DirectiveArgType.DIRARG_INTERNAL, new DirInCharacterList(), new DirOutCharacterList()),
        ...
        new Directive(new String[] {"CHARACTER", "RELIABILITIES", "", ""}, 4, ConforDirType.CHARACTER_RELIABILITIES, DirectiveArgType.DIRARG_CHARREALLIST, new DirInDefault(), new DirOutDefault()),
        new Directive(new String[] {"CHARACTER", "TYPES", "", ""}, 2, ConforDirType.CHARACTER_TYPES, DirectiveArgType.DIRARG_INTERNAL, new DirInCharTypes(), new DirOutCharTypes()),
        new Directive(new String[] {"CHARACTER", "WEIGHTS", "", ""}, 4, ConforDirType.CHARACTER_WEIGHTS, DirectiveArgType.DIRARG_CHARREALLIST, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"CHECK", "FOR", "CD", ""}, 0, ConforDirType.CHECK_FOR_CD, DirectiveArgType.DIRARG_TEXT, new DirInDefault(), new DirOutDefault()),
        new Directive(new String[] {"CHINESE", "FORMAT", "", ""}, 4, ConforDirType.CHINESE_FORMAT, DirectiveArgType.DIRARG_NONE, new DirInDefault(), new DirOutDefault()),
        new Directive(new String[] {"COMMENT", "", "", ""}, 0, ConforDirType.COMMENT, DirectiveArgType.DIRARG_COMMENT, new DirInComment(), new DirOutDefault()),
        new Directive(new String[] {"DATA", "BUFFER", "SIZE", ""}, 1, ConforDirType.DATA_BUFFER_SIZE, DirectiveArgType.DIRARG_INTEGER, new DirInDefault(), new DirOutDataBufferSize()),
        ...
        new Directive(new String[] {"DEPENDENT", "CHARACTERS", "", ""}, 4, ConforDirType.DEPENDENT_CHARACTERS, DirectiveArgType.DIRARG_INTERNAL, new DirInDependentChars(), new DirOutDependentChars()),
        ...
        new Directive(new String[] {"EXCLUDE", "CHARACTERS", "", ""}, 4, ConforDirType.EXCLUDE_CHARACTERS, DirectiveArgType.DIRARG_CHARLIST, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"HEADING", "", "", ""}, 0, ConforDirType.HEADING, DirectiveArgType.DIRARG_TEXT, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"IMPLICIT", "VALUES", "", ""}, 4, ConforDirType.IMPLICIT_VALUES, DirectiveArgType.DIRARG_INTERNAL, new DirInImplicitValues(), new DirOutImplicitValues()),
        ...
        new Directive(new String[] {"INPUT", "FILE", "", ""}, 0, ConforDirType.INPUT_FILE, DirectiveArgType.DIRARG_FILE, new DirInInputFile(), new DirOutDefault()),
        ...
        new Directive(new String[] {"INSERT", "IMPLICIT", "VALUES", ""}, 4, ConforDirType.INSERT_IMPLICIT_VALUES, DirectiveArgType.DIRARG_NONE, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"ITEM", "DESCRIPTIONS", "", ""}, 5, ConforDirType.ITEM_DESCRIPTIONS, DirectiveArgType.DIRARG_INTERNAL, new DirInItemDescriptions(), new DirOutItemDescriptions()),
        ...
        new Directive(new String[] {"ITEM", "SUBHEADINGS", "", ""}, 4, ConforDirType.ITEM_SUBHEADINGS, DirectiveArgType.DIRARG_CHARTEXTLIST, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"MANDATORY", "CHARACTERS", "", ""}, 4, ConforDirType.MANDATORY_CHARACTERS, DirectiveArgType.DIRARG_INTERNAL, new DirInMandatoryChars(), new DirOutMandatoryChars()),
        new Directive(new String[] {"MAXIMUM", "NUMBER", "OF", "ITEMS"}, 1, ConforDirType.MAXIMUM_NUMBER_OF_ITEMS, DirectiveArgType.DIRARG_INTERNAL, new DirInMaxNumberItems(), new DirOutMaxNumberItems()),
        new Directive(new String[] {"MAXIMUM", "NUMBER", "OF", "STATES"}, 1, ConforDirType.MAXIMUM_NUMBER_OF_STATES, DirectiveArgType.DIRARG_INTERNAL, new DirInMaxNumberStates(), new DirOutMaxNumberStates()),
        ...
        new Directive(new String[] {"NEW", "PARAGRAPHS", "AT", "CHARACTERS"}, 4, ConforDirType.NEW_PARAGRAPHS_AT_CHARACTERS, DirectiveArgType.DIRARG_CHARLIST, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"NUMBER", "OF", "CHARACTERS", ""}, 1, ConforDirType.NUMBER_OF_CHARACTERS, DirectiveArgType.DIRARG_INTERNAL, new DirInNumberChars(), new DirOutNumberChars()),
        ...
        new Directive(new String[] {"NUMBERS", "OF", "STATES", ""}, 3, ConforDirType.NUMBERS_OF_STATES, DirectiveArgType.DIRARG_INTERNAL, new DirInNumberStates(), new DirOutNumberStates()),
        ...
        new Directive(new String[] {"OMIT", "INAPPLICABLES", "", ""}, 4, ConforDirType.OMIT_INAPPLICABLES, DirectiveArgType.DIRARG_NONE, new DirInDefault(), new DirOutDefault()),
        new Directive(new String[] {"OMIT", "INNER", "COMMENTS", ""}, 4, ConforDirType.OMIT_INNER_COMMENTS, DirectiveArgType.DIRARG_NONE, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"OMIT", "TYPESETTING", "MARKS", ""}, 4, ConforDirType.OMIT_TYPESETTING_MARKS, DirectiveArgType.DIRARG_NONE, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"OUTPUT", "FORMAT", "HTML", ""}, 4, ConforDirType.OUTPUT_FORMAT_HTML, DirectiveArgType.DIRARG_NONE, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"PRINT", "FILE", "", ""}, 0, ConforDirType.PRINT_FILE, DirectiveArgType.DIRARG_FILE, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"PRINT", "WIDTH", "", ""}, 0, ConforDirType.PRINT_WIDTH, DirectiveArgType.DIRARG_INTEGER, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"REPLACE", "ANGLE", "BRACKETS", ""}, 4, ConforDirType.REPLACE_ANGLE_BRACKETS, DirectiveArgType.DIRARG_NONE, new DirInDefault(), new DirOutDefault()),
        ...
        new Directive(new String[] {"SHOW", "", "", ""}, 0, ConforDirType.SHOW, DirectiveArgType.DIRARG_TEXT, new DirInShow(), new DirOutDefault()),
        ...
        new Directive(new String[] {"TYPESETTING", "MARKS", "", ""}, 4, ConforDirType.TYPESETTING_MARKS, DirectiveArgType.DIRARG_TEXTLIST, new DirInDefault(), new DirOutDefault()),

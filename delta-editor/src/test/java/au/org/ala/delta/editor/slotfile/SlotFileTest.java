 ...
 */
public class SlotFileTest extends DeltaTestCase {
	...
	/**
	 * Utility method that reads all of the slot headers in the supplied SlotFile and returns them.
	 * 
	 * @param slotFile
	 *            the SlotFile to read.
	 * @return a TreeMap keyed by file position containing the SlotHeader at each position.
	 * @throws IOException
	...
	/**
	 * Test method for {@link au.org.ala.delta.editor.slotfile.SlotFile#allocSlot(int, int, int, int)}.
	 */
	@Test
	...
	/**
	 * Tests the growSlotData method. TODO add a test for reusing a slot.
	 */
	@Test
	public void testGrowSlotData() throws Exception {
	...
	/**
	 * Tests the copySlotData method. TODO add a test for: large data size (above buffer size) and make sure the data is actually the same
	 */
	@Test
	public void testCopySlotData() throws Exception {

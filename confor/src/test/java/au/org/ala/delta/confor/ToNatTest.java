...
public class ToNatTest extends ConforTestCase {
	...
	public void testSampleToNat() throws Exception {
		...
		File expectedFile = new File(FilenameUtils.concat(_samplePath, "expected_results/tonat.prt"));
		String expected = FileUtils.readFileToString(expectedFile, "cp1252");

		System.out.println(expected);
		
		File actualFile = new File(FilenameUtils.concat(_samplePath, "tonat.prt"));

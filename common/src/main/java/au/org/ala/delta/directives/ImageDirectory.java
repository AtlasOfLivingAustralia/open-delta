...
/**
 * Processes the IMAGE DIRECTORY directive.
 * @see http://delta-intkey.com/www/uguide.htm#_*OUTPUT_DIRECTORY_ 
 *
 */
public class ImageDirectory extends AbstractTextDirective {
	...
	public void process(DeltaContext context, DirectiveArguments args) throws Exception {
		...
		context.getOutputFileSelector().setImageDirectory(directoryName);
	}

...
public class DirectiveError {
	...
	public enum Error {
        ...
        VALUE_LESS_THAN_MIN(61), VALUE_GREATER_THAN_MAX(62),
	...
	public enum Warning {
		EQUIVALENT_DIRECTIVE_USED(3), CHARACTER_ALREADY_SPECIFIED(64), TAXON_NAMES_DUPLICATED_OR_UNMATCHED(103), FIRST_ITEM_CANNOT_BE_VARIANT(158),
        CHARACTER_IS_NOT_REAL(177), CANNOT_MAKE_ITEM_VARIANT(178), CANNOT_MAKE_ITEM_NON_VARIANT(179), ITEM_EXISTS(180);

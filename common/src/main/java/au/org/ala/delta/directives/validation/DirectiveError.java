...
public class DirectiveError {
	...
	public enum Error {
		...
		STATE_NUMBER_EXPECTED(9),
		MISSING_DATA(10), ILLEGAL_VALUE(12), 
		NUMBER_OF_STATES_WRONG(13), 
		TOO_MANY_UNITS(18), STATES_NOT_ALLOWED(19),
		...
		CHARACTERS_MUST_BE_SAME_TYPE(132), STATE_NUMBER_GREATER_THAN_MAX(138), 
